...
Lightspeed, опрашиваются по их протоколу HID++. Игровые гарнитуры Logitech
и устройства других производителей с фирменным протоколом заряд не отдают —
у них поле остаётся пустым.

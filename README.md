...
него, случайно ничего не нажать. В режиме «без подложки» остаётся только
текст поверх обоев; там же настраиваются непрозрачность и состав списка.

Всё остальное — в окне «Настройки → Все настройки»: список, автозапуск,

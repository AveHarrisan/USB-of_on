...
Lightspeed, опрашиваются по их протоколу HID++. Заряд устройств Logitech программа берёт у G HUB, пока он запущен: он и так
их опрашивает, поэтому лишних пробуждений нет. Без G HUB мыши и клавиатуры
опрашиваются напрямую по HID++, а гарнитуры заряд не отдают — своего
протокола они не раскрывают. Пока окно спрятано в трей и виджет выключен, заряд
не запрашивается вовсе, а прямой опрос устройств (он будит беспроводные)
по умолчанию выключен — включается в «Настройках». Устройства
...
него, случайно ничего не нажать.

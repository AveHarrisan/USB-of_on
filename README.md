...
Windows) и у HID-устройств со стандартным отчётом о батарее. Устройства
с фирменным протоколом — приёмники Logitech, игровые гарнитуры — заряд
системе не сообщают, у них поле остаётся пустым.

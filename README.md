...
Lightspeed, опрашиваются по их протоколу HID++. Заряд игровых гарнитур Logitech (PRO X 2 и подобных) программа берёт
у G HUB, пока он запущен: своего протокола они не раскрывают. Устройства
